...
public class ThisMonthItemRecyclerViewAdapter extends RecyclerView.Adapter<ThisMonthItemRecyclerViewAdapter.ViewHolder> implements AssortmentOfDateTime {


    private List<Task> taskList;
    private DeleteTaskListener deleteTaskListener;

    public ThisMonthItemRecyclerViewAdapter(){
        this.taskList = new ArrayList<>();
    }

    @Override
    public int getItemViewType(int position) {
        Log.i("さしすせｓ」", String.valueOf(position));
